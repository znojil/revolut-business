 ...
 * @testCase
 */
final class UpdateLabelRequestTest extends \Tester\TestCase{

	public function testConfiguration(): void{
		$request = new \Znojil\RevolutBusiness\Request\UpdateLabelRequest('123e4567-e89b-12d3-a456-426614174000', '123e4567-e89b-12d3-a456-426614174000', '20% VAT');
...
(new UpdateLabelRequestTest)->run();
